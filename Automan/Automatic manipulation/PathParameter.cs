...
namespace NanoExperiment.Automanipulation
{
    public partial class PathParameter : Form
    {
        ...
        private void eTextBox_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if ((int)e.KeyChar == 46)                           //小数点
            {
                ...
                else
                {
                    ...
                    b1 = float.TryParse(eTextBox.Text, out oldf);
                    b2 = float.TryParse(eTextBox.Text + e.KeyChar.ToString(), out f);
                    if (b2 == false)
                    {
                        if (b1 == true)
                            e.Handled = true;
        ...
        private void qTextBox_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if ((int)e.KeyChar == 46)                           //小数点
            {
                ...
                else
                {
                    ...
                    float oldf;
                    bool b1 = false, b2 = false;
                    b1 = float.TryParse(qTextBox.Text, out oldf);
                    b2 = float.TryParse(qTextBox.Text + e.KeyChar.ToString(), out f);
                    if (b2 == false)
                    {
                        if (b1 == true)
                            e.Handled = true;
        ...
        private void pushSpeedTextBox_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if ((int)e.KeyChar == 46)                           //小数点
            {
                if (pushSpeedTextBox.Text.Length <= 0)
                    e.Handled = true;   //小数点不能在第一位
                else
                {
                    float f;
                    float oldf;
                    bool b1 = false, b2 = false;
                    b1 = float.TryParse(pushSpeedTextBox.Text, out oldf);
                    b2 = float.TryParse(pushSpeedTextBox.Text + e.KeyChar.ToString(), out f);
                    if (b2 == false)
                    {
                        if (b1 == true)
                            e.Handled = true;
        ...
        private void pushStepTextBox_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (((int)e.KeyChar < 48 || (int)e.KeyChar > 57) && (int)e.KeyChar != 8 && (int)e.KeyChar != 46)
                e.Handled = true;
            //小数点的处理。
            if ((int)e.KeyChar == 46)                           //小数点
            {
                if (pushStepTextBox.Text.Length <= 0)
                    e.Handled = true;   //小数点不能在第一位
                else
                {
                    float f;
                    float oldf;
                    bool b1 = false, b2 = false;
                    b1 = float.TryParse(pushStepTextBox.Text, out oldf);
                    b2 = float.TryParse(pushStepTextBox.Text + e.KeyChar.ToString(), out f);
                    if (b2 == false)
                    {
                        if (b1 == true)
                            e.Handled = true;
        ...
        private void tTextBox_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if ((int)e.KeyChar == 46)                           //小数点
            {
                ...
                else
                {
                    ...
                    float oldf;
                    bool b1 = false, b2 = false;
                    b1 = float.TryParse(tTextBox.Text, out oldf);
                    b2 = float.TryParse(tTextBox.Text + e.KeyChar.ToString(), out f);
                    if (b2 == false)
                    {
                        if (b1 == true)
                            e.Handled = true;
        ...
        private void probeRadiusTextBox_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (((int)e.KeyChar < 48 || (int)e.KeyChar > 57) && (int)e.KeyChar != 8 && (int)e.KeyChar != 46)
                e.Handled = true;
            //小数点的处理。
        ...
        {
            eTextBox.Text = Convert.ToString(SavePath.e);
            qTextBox.Text = Convert.ToString(SavePath.q);
